...
(function(root, factory) {
    ...
    let pipwerks = {}; // pipwerks 'namespace' helps ensure no conflicts with possible other "SCORM" variables
    ...
    pipwerks.SCORM.API.find = function(win) {
        ...
        let traceMsgPrefix = 'SCORM.API.find';
        let { trace } = pipwerks.UTILS;
    ...
    pipwerks.SCORM.connection.initialize = function() {
        ...
        let { trace } = pipwerks.UTILS;
        let makeBoolean = pipwerks.UTILS.StringToBoolean;
        let { debug } = scorm;
